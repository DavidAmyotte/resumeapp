...
const HeaderNotificationsCustomContent = (props) => ( <
    ul id = "header-notifications-custom-popover-content" > {
        props.items.map((item) => ( <
            ...
            title = { item.comment } > { item.comment } <
            /p> <
            p className = "slds-m-top_x-small slds-text-color_weak" > { item.timePosted } { ' ' } {
                item.unread ? ( <
                    abbr className = "slds-text-link slds-m-horizontal_xxx-small"
                    title = "unread" >
                    ●
                    <
                    /abbr>
...
const HeaderProfileCustomContent = (props) => ( <
    ...
    p className = "slds-truncate" >
    <
    a className = "slds-m-right_medium"
...
class Viewer extends React.Component {
    ...
    render() {
        return ( <
            ...
            /> <
            GlobalHeaderFavorites actionSelected = { this.state.favoritesActionSelected }
...
Viewer.displayName = 'GlobalHeaderExample';
